class Pbctl < Formula
  ...
  url      "https://github.com/hakonharnes/pbctl/archive/refs/tags/v0.4.7.tar.gz"
  sha256   "292097899f3cf5fd7d1b09daaa04dad96f6935feae4a4dc8c58b1d603b3ee90d"
  license  "MIT"
  ...
  test do
    assert_match "pbctl 0.4.7", shell_output("#{bin}/pbctl --version")
  end
end
